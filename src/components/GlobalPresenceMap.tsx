        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-200">
          ...
          <div className="relative aspect-[2000/857] bg-[#d0e0e8]">
            <svg 
              ...
              strokeWidth="0.5"
            >
              {/* I'll simplify the SVG paths for the demo but keep the logic */}
              {/* In a real scenario, we'd include all 100+ paths here */}
              <path 
                className="allPaths hover:fill-primary transition-colors cursor-pointer"
